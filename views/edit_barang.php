...
<!-- Page Heading -->
<!-- <h1 class="h3 mb2-2 text-gray-000"><?= $halaman ?></h1> -->

<!-- DataTables example -->
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">From Edit Peminjaman</h6>
    </div>
    <div class="card body">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="form-group">
                    <input type="submit" class="btn btn-primary btn-user btn-block" value="Ubah Data" id="exampleInputEmail" name="login">
                </div>
            </form>
            </div>
            <div class="col-lg-2"></div>
